<template>
    <div>
        ...
        <div class="table-box">
            ...
            <el-dialog v-loading="loadingBooleanUpdate" title="添加/修改" :visible.sync="dialogVisible" width="67%">
            ...
            <el-dialog title="分配角色" :visible.sync="dialogRoleVisible">
                <el-form v-loading="loadingAssign" label-width="80px">
                ...
                <div slot="footer">
                <el-button :loading="loadingAssign" type="primary" size="small" @click="assignRole">保存</el-button>
    ...
    methods: {
        ...
        showAssignRole(row) {
            ...
            roleApi.getRolesByUserId(row.id).then(response => {
                ...
                this.userRoleIds = response.data.data.userRoleIds
        ...
        */
        ...
        edit(id) {  
            // 弹出框
            this.dialogVisible = true
            this.loadingBooleanUpdate = true
            console.log(this.loadingBooleanUpdate)
            // 调用接口查询
            userApi.getUserById(id).then(response => {
                this.sysUser = response.data.data
            }).finally(() => {
                this.loadingBooleanUpdate = false
            })
        },
        // 修改
        update() {
